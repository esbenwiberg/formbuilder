        ...
        return {
            options: {
                ...
                properties: {
                    ...
                    awesomeDesc: propertyOptionsFactory.string({ displayName: "Why are you awesome?", hide: (item: IMyTabGroupedFormItem) => !item.awesome, group: "groupTwo", config: { type: "password" } }),
                } 
